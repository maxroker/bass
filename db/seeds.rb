...
a1 = Album.create(cover: "https://images-na.ssl-images-amazon.com/images/I/91dHRGIV65L._SY355_.jpg", title: "My Beautiful Dark Twisted Fantasy", artist: "Kanye West")
...
a2 = Album.create(cover: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Beyonc%C3%A9_-_Beyonc%C3%A9.svg/1200px-Beyonc%C3%A9_-_Beyonc%C3%A9.svg.png", title: "Beyonce", artist: "Beyonce")
...
a3 = Album.create(cover: "https://upload.wikimedia.org/wikipedia/ru/5/55/21Adele.jpg", title: "21", artist: "Adele")
...
a4 = Album.create(cover: "https://images.genius.com/a2a52c3c2502d8694c6ab464beadd7b1.1000x1000x1.jpg", title: "Channel Orange", artist: "Frank Ocean")
...
a5 = Album.create(cover: "https://www.udiscovermusic.com/wp-content/uploads/2017/10/Kendrick-Lamar-Good-Kid-Maad-City-1.jpg", title: "Good Kid, M.A.A.D City", artist: "Kendrick Lamar")
...
a6 = Album.create(cover: "https://images-na.ssl-images-amazon.com/images/I/61Uxg-SWExL._SL1500_.jpg", title: "Random Access Memories", artist: "Daft Punk")
...
a7 = Album.create(cover: "https://images-na.ssl-images-amazon.com/images/I/81iBWUUcjTL._SL1500_.jpg", title: "The 20/20 Experience", artist: "Justin Timberlake")
